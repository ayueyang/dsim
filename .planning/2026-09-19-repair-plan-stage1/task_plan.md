...
## 批次A返工 + 批次B（2026-09-20，基线dd5a114）
- Phase24 T3.4时间戳精确判重、4秒反例红绿及F11 lint守卫：complete；1281bfd/469c788，历史导入49a695d；现场双机复验见Phase29。
- Phase25 T2.1：complete，b4d3d4d，5例仪器/编译/JVM通过。
