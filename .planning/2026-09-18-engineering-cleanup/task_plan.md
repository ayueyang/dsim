...
- [x] S13 W21: control messages through SyncOutbox; tests + emulator + docs + commit
- [x] S12 W7: globalMqttClient private, publishToGroup single entry, 7 sites migrated; build + emulator + docs + commit
